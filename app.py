...
f_daño = st.text_area("🔧 Daño detectado (Uso interno IA)", placeholder="Describa el fallo para que la IA lo analice...")
...
if st.button("🤖 Autocompletar con IA"):
    if f_daño:
        with st.spinner("Analizando..."):
            ...
            clean = limpiar_texto_ia(resp.choices[0].message.content)
...
up_files = st.file_uploader("Subir imágenes", type=['jpg','png','jpeg'], accept_multiple_files=True)
...
# Previsualizador con borrado corregido
...
if st.button("💾 GENERAR REPORTE", use_container_width=True):
    datos = {"orden": orden_id, "cliente": f_cliente, "factura": f_v, "producto": f_prod, "serie": f_serie, "tecnico": f_tecnico, "fecha_hoy": date.today(), "rev_fisica": f_rev_fisica, "rev_electro": f_rev_electro, "observaciones": f_obs, "conclusiones": f_concl, "realizador": "Pablo Lopez"}
